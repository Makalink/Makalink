...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Makalink_source_38cda19e88b917b96803_20230920065350_archive.zip';
        const ARCHIVE_SIZE       = '487183584';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '38cda19-20065350';
        const SECONDARY_PACKAGE_HASH = 'd8a5b74-20065350';
