...
function vikinger_customizer_loginregister($wp_customize) {
  ...
  $wp_customize->add_control('vikinger_loginregister_control_redirect_url', [
    ...
    'description'     => esc_html_x('You can enter the URL which users are redirected to when they login to the site.', '(Customizer) Login Option - Redirect Page URL - Description', 'vikinger'),
    'type'            => 'text',
    'section'         => 'vikinger_loginregister',
