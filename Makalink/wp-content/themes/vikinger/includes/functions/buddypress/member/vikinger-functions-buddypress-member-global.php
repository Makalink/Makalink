...
if (!function_exists('vikinger_member_types_get')) {
  /**
   * Returns member types.
   * 
   * @since 1.9.8.1
   * 
   * @return array $member_types        Member types.
   */
  function vikinger_member_types_get() {
...
if (!function_exists('vikinger_member_get_user_base_data')) {
  ...
  function vikinger_member_get_user_base_data($bp_member) {
    $user_base_data = [
      'id'                              => $bp_member['id'],
      'name'                            => $bp_member['name'],
      'member_types'                    => $bp_member['member_types'],
