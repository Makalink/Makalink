 ...
 */
  ...
  $error_button_text  = get_theme_mod('vikinger_404_setting_button_text', esc_html__('Go Home', 'vikinger'));
...
<div class="content-grid">
  ...
  <div class="error-section">
    ...
    <a href="<?php echo esc_url(apply_filters('vikinger_404_button_url', home_url('/'))); ?>" class="error-section-button button medium primary"><?php echo esc_html($error_button_text); ?></a>
  </div>
  <!-- /ERROR SECTION -->
</div>
<!-- /CONTENT GRID -->
