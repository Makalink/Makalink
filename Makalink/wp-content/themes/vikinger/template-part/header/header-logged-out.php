...
<nav id="navigation-widget-mobile" class="navigation-widget navigation-widget-mobile sidebar left navigation-widget-hidden" data-simplebar>
  ...
  <?php if ($vikinger_settings['users_can_register']) : ?>
    <!-- BUTTON -->
  ...
  <?php endif; ?>
    ...
    <!-- BUTTON -->
    <a class="button primary login-button" href="<?php echo esc_url(vikinger_login_page_url_get()); ?>"><?php esc_html_e('Connect Wallet', 'vikinger'); ?></a>
    <!-- /BUTTON -->
  </div>
  <!-- /NAVIGATION WIDGET ACTIONS -->
